...
const Banner = ({className,label,labelStyles}: Props) => {
  return (
    <div className={cn('h-[400px] w-full relative flex items-center  justify-center',className)}>
        <ImageComponent className='absolute w-full h-full' imgClassName='object-cover' alt='banner' src='/banner.jpg' aspect='video' />
